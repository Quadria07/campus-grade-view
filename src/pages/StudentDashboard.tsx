    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-2 sm:px-4 py-2 sm:py-4 lg:py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-4 sm:space-y-6">
          <TabsList className="grid w-full grid-cols-4 h-auto p-1 bg-white shadow-sm rounded-lg">
            <TabsTrigger 
              value="profile" 
              className="flex flex-col items-center text-xs sm:text-sm px-1 sm:px-2 py-2 sm:py-3 data-[state=active]:bg-primary data-[state=active]:text-white rounded-md transition-all"
            >
